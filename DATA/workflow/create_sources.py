...
def run_layer0(db, log, path):
    ...
    if db == 'acsn':
        ...
        from DATA.workflow.layer0.databases.acsn import script
        ...
        from DATA.workflow.layer0.databases.innatedb import script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
        ...
        from DATA.workflow.layer0.databases.reactome import script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
        script.DATA_FILE = data_file_loc
        ...
        from DATA.workflow.layer0.databases.signor import script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
        ...
        from DATA.workflow.layer0.databases.signafish import script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
        script.DATA_FILE = data_file_loc
        ...
        from DATA.workflow.layer0.databases.slk2 import script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
        ...
        from DATA.workflow.layer0.databases.slk21 import script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
        ...
        from DATA.workflow.layer0.databases.slk3 import script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
        ...
        from DATA.workflow.layer0.databases.tcr import script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
...
def run_layer2(db, log, path):
    if db == 'PhosphoSite':
        from DATA.workflow.layer2.databases.PhosphoSite import script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
        ...
        from DATA.workflow.layer2.databases.ELMpred import pred_new as script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
        ...
        script.file_list = []
        script.pred_db = 'layer2/databases/ELMpred/ELM_pred.db'
        script.EXPORT_DB_LOCATION = 'all_output/ELM'

        return script.main(logger=log)

    if db == 'PTMCode2':
        from DATA.workflow.layer2.databases.PTMCode2 import script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
...
def run_layer3(db, log, path):
    if db == 'biogrid':
        from DATA.workflow.layer3.databases.biogrid import new_script
        ...
        from DATA.workflow.layer3.databases.ComPPI import script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
        ...
        from DATA.workflow.layer3.databases.HPRD import script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
        ...
        from DATA.workflow.layer3.databases.IntAct import script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
        ...
        from DATA.workflow.layer3.databases.OmniPath import script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
        script.DATA_FILE = data_file_loc
...
def run_layer5(db, log, path):
    if db == 'miR2Disease':
        from DATA.workflow.layer5.databases.miR2Disease import script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
        ...
        from DATA.workflow.layer5.databases.miRDeathDB import script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
        ...
        from DATA.workflow.layer5.databases.miRecords import script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
        script.DATA_FILE = data_file_loc
        ...
        from DATA.workflow.layer5.databases.TarBase import script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
        ...
        from DATA.workflow.layer5.databases.starBase import script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
        ...
        from DATA.workflow.layer5.databases.miRSponge import script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
        script.DATA_FILE = data_file_loc
...
def run_layer6(db, log, path):
    if db == 'TFBS':
        from DATA.workflow.layer6.databases.TFBS import script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
        ...
        from DATA.workflow.layer6.databases.TFBS_Orsi import script2 as script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
...
def run_layer7(db, log, path):
    if db == 'lncRInter':
        from DATA.workflow.layer7.databases.lncRInter import script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
        ...
        from DATA.workflow.layer7.databases.starbase import script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
        ...
        from DATA.workflow.layer7.databases.NPInter import script
        script.SQL_SEED = '../../SLKlib/SQLiteDBApi/network-db-seed.sql'
        script.DATA_FILE = data_file_loc
...
for layer in DB_DICT.keys():
    for db in DB_DICT[layer]:
        ...
        if layer == 'layer0':
            ...
            run_layer2(db, log=logger, path=runpath)
        elif layer == 'layer3':
            run_layer3(db, log=logger, path=runpath)
        if layer == 'layer5':
            run_layer5(db, log=logger, path=runpath)
        elif layer == 'layer6':
            run_layer6(db, log=logger, path=runpath)
        elif layer == 'layer7':
            run_layer7(db, log=logger, path=runpath)
